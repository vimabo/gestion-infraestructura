...
public interface EmpleadoDao extends JpaRepository<Empleado, Long> {
    ...
    /**
     * Metodo que retorna un Empleado a partir de su tipo de documento y numero
     * de documento.
     *
    ...
    /**
     * Metodo que retorna una Lista de Empleados a partir de una lista de ids
     *
     * @param ids List long
     * @return Lista Empleado
     * @author vbocanegra
     */
    @Query("SELECT e FROM Empleado e WHERE e.empleadoId IN ?1")
    List<Empleado> findEmpleadosById(List<Long> ids);
}
